 ...
 * 
 */
public class AverageDepTimeAndArriveTimeBefore2001 {
    ...
    public static class averagemapper extends Mapper<LongWritable, Text, Text, IntWritable> {
        ...
        public void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
            if (key.get() > 0) {
                ...
                t1.set(lines[8]); // the 8th index is that for the carrier of airline
    ...
    public static void main(String[] args) throws Exception {
		...
		Job job = Job.getInstance(conf, "Find Average DepTime/ArriveTime Per Carrier before 2001");
		job.setJarByClass(AverageDepTimeAndArriveTimeBefore2001.class);
