 ...
 * 
 */
public class MaxMinDepDelayAndArriveDelayFromAirport {
    ...
    public static void main(String[] args) throws Exception {
		...
		Job job = Job.getInstance(conf, "Find Minimum and Maximum for departureDelay and arrive delay for airports");
		job.setJarByClass(MaxMinDepDelayAndArriveDelayFromAirport.class);
